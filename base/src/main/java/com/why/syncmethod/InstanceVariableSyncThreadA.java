 ...
 */
public class InstanceVariableSyncThreadA extends Thread{

    private InstanceVariableSync instanceVariableSync;

    public InstanceVariableSyncThreadA(InstanceVariableSync instanceVariableSync) {
